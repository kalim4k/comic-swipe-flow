  ...
  const toggleGeneration = () => {
    ...
    toast({
      ...
      description: isGenerating 
        ? "Les avis générés automatiquement sont maintenant désactivés" 
        : "Les avis générés automatiquement sont maintenant activés",
    });
  };
        ...
        <div className="flex flex-col h-full space-y-6">
          ...
          <div className="w-full max-w-md mx-auto animate-fade-in">
            <form 
              ...
              className="p-6 rounded-2xl bg-black/20 backdrop-blur-sm border border-white/10 shadow-xl"
            >
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <Textarea 
                    ...
                    className="bg-white/5 border-white/10 text-white resize-none min-h-24"
                    placeholder="Partagez votre experience avec nos BD..."
                  />
                </div>
            ...
            <div className="flex justify-center my-4">
              ...
              >
                {isGenerating ? 'Désactiver' : 'Activer'} la génération automatique
              </Button>
            </div>
          </div>

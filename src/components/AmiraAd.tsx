...
const AmiraAd: React.FC<AmiraAdProps> = ({ onClose }) => {
  return (
    <div className="fixed inset-0 z-50 flex flex-col items-center justify-center backdrop-blur-md animate-fade-in bg-gradient-to-b from-indigo-900/90 via-black/95 to-purple-900/90">

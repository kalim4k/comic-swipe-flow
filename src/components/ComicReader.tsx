...
const ComicReader = () => {
  ...
  return (
    <div className="relative flex flex-col h-full w-full bg-gradient-to-b from-black via-comic to-black overflow-hidden">
        ...
        <div className="flex justify-between items-center">
          ...
          <div className="flex flex-col items-end">
            ...
            <div className="w-24 h-1 bg-gray-800 rounded overflow-hidden">
              <div 
                className="h-full bg-gradient-to-r from-comic-accent to-blue-400 transition-all duration-300"
      ...
      <div 
        className="comic-swipe-container relative w-full h-full overflow-hidden"
        {...swipeHandlers}
      >
